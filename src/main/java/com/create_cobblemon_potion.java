...
@Mod(create_cobblemon_potion.MODID)
public class create_cobblemon_potion
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "create_cobblemon_potion";
...
//            }).build());
    ...
    public create_cobblemon_potion(IEventBus modEventBus, ModContainer modContainer)
    {
